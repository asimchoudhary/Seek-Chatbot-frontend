<template>
  <div class="homeView">
      ...
      <div class="profile-container">
        ...
        <div class="nav-links">
          ...
          <template v-if="userRole === 'Student'">
            <router-link to="/mycourses" class="nav-item"
          ...
          <template v-if="userRole === 'Instructor'">
            <router-link to="/instructor" class="nav-item"
    ...
    <div class="container text-center mt-5">
      <h1 class="welcome-title animated-fade">
        Welcome to the BS-Degree Program
      </h1>
    ...
    <div class="container text-center mt-4">
      <template v-if="hasUnseenReplies">
        <router-link to="/studentqueries">
          <img
            src="../assets/botnotification.png"
            alt="botNotification"
            class="botnotification-icon"
        /></router-link>
      </template>
      <template v-else>
        ...
        <img
          ...
          alt="Chatbot"
          class="img-fluid chatbot-img animated-fade"
        />
      </template>
    </div>
    ...
    async checkUnseenReplies(email) {
      try {
        ...
        const unseenReplies = response.data.some(
          (query) =>
            query.student_email === email && query.reply && !query.reply_seen
        );
