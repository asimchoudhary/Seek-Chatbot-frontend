<template>
  <div class="ta-queries-page">
    ...
    <div v-if="loading" class="loading">Loading student queries...</div>
        ...
        <tr v-for="doubt in doubts" :key="doubt.doubt_id">
          ...
          <td class="reply-column">
            ...
            <div v-if="doubt.reply">
              <button class="view-reply-button" @click="fetchReply(doubt)">
                View Reply
              </button>
              <div v-if="doubt.showReplyBox" class="reply-display">
                ...
                <button
                  class="close-button"
                  @click="doubt.showReplyBox = false"
                >
                  Close
                </button>
              </div>
    ...
    async fetchReply(doubt) {
      try {
        const response = await axios.get(
          `${this.baseURL}/api/doubts/${doubt.doubt_id}/reply`
        );
