        ...
        <div class="courses-container">
          <div class="course-card question-block">
            ...
            <p class="course-description">
              Learn the fundamentals of Python programming language, from basic
              syntax to advanced concepts. This comprehensive course covers
            ...
            <div class="button-container">
              <router-link to="/coursepage" class="submit-button"
          ...
          <div class="course-card question-block">
            ...
            <p class="course-description">
              Master the basics of JavaScript for web development. This
              interactive course teaches you DOM manipulation, event handling,
              asynchronous programming with promises, and modern ES6+ features.
            </p>
            <div class="course-details">
            ...
            <div class="button-container">
              <router-link to="/javascript-course" class="submit-button"
                >View Course</router-link
              >
            </div>
          </div>
          ...
          <div class="course-card question-block">
            ...
            <p class="course-description">
              Explore neural networks and advanced AI techniques in this
              cutting-edge course. Learn about convolutional neural networks,
              recurrent neural networks, and how to implement them using popular
              frameworks.
            </p>
            <div class="course-details">
            ...
            <div class="button-container">
              <router-link to="/deep-learning" class="submit-button"
                >View Course</router-link
              >
            </div>
          </div>
    ...
    async checkUnseenReplies() {
      try {
        ...
        const response = await axios.get(
          "https://seek-protal-gzcname5gsghfhhj.centralindia-01.azurewebsites.net/api/student-doubts"
        );
