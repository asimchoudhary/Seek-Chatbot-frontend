<template>
  <div class="ta-page">
    ...
    <div class="content-container">
      <div class="actions">
        <router-link to="/managestudents"
          ><button class="review-students">Review Students</button></router-link
        >
        <button class="approve-registration">Approve Registration</button>
        <router-link to="/taquery"
          ><button class="student-queries">Student Queries</button></router-link
        >
      </div>
...
export default {
  ...
  methods: {
    ...
    renderChart(labels, scores) {
      const ctx = document
        .getElementById("weeklyAverageChartTaPage")
        .getContext("2d");
      new Chart(ctx, {
        type: "bar",
        data: {
