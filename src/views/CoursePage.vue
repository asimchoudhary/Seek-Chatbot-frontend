        ...
        <div v-for="week in weeks" :key="week.week_no" class="week">
          <div @click="toggleWeek(week.week_no)" class="week-title">
            ...
            <span class="toggle-icon">{{
              openWeeks.includes(week.week_no) ? "▲" : "▼"
            }}</span>
          </div>
          ...
          <div v-if="openWeeks.includes(week.week_no)" class="week-content">
            <div
              ...
              class="lecture-title"
              @click="toggleLecture(lecture.lecture_id)"
            >
            ...
            <div class="supplementary-section">
              <div class="supplementary-header">📚 Supplementary Materials</div>
              <div
                v-if="
                  supplementaryMaterials[week.week_no] &&
                  supplementaryMaterials[week.week_no].length > 0
                "
              >
                <div
                  v-for="material in supplementaryMaterials[week.week_no]"
                  :key="material.id"
                  class="supplementary-item"
                >
                  <a
                    @click="viewSupplementary(material.file_url)"
                    class="supplementary-link"
                  >
                    📄 {{ material.file_name }}
                  </a>
                </div>
            ...
            <router-link to="prassignment" class="assignment-link"
              >📝 Graded Assignment</router-link
            >
            <router-link to="prgassignment" class="assignment-link"
              >💻 Programming Assignment</router-link
            >
          </div>
        </div>
      </aside>
...
export default {
          ...
          lectures: [
            {
              ...
              lecture_no: "1.1",
              title: "Introduction",
              video_link: "https://www.youtube.com/embed/8ndsDXohLMQ",
            },
            {
              lecture_id: 2,
              lecture_no: "1.2",
              title: "Introduction to Replit",
              video_link: "https://www.youtube.com/embed/NgZZ0HIUqbs",
            },
            {
              lecture_id: 3,
              lecture_no: "1.3",
              title: "A Quick Introduction to Variables",
              video_link: "https://www.youtube.com/embed/Yg6xzi2ie5s",
            },
            {
              lecture_id: 4,
              lecture_no: "1.4",
              title: "Variables and Literals",
              video_link: "https://www.youtube.com/embed/tDaXdoKfX0k",
            },
            {
              lecture_id: 5,
              lecture_no: "1.5",
              title: "Data Types",
              video_link: "https://www.youtube.com/embed/8n4MBjuDBu4",
            },
            {
              lecture_id: 6,
              lecture_no: "1.6",
              title: "Operators and Expressions",
              video_link: "https://www.youtube.com/embed/8pu73HKzNOE",
            },
            {
              lecture_id: 7,
              lecture_no: "1.7",
              title: "Intro to Strings",
              video_link: "https://www.youtube.com/embed/sS89tiDuqoM",
            },
          ],
        },
        {
          ...
          lectures: [
            {
              ...
              lecture_no: "2.1",
              title: "Variables",
              video_link: "https://www.youtube.com/embed/XZSnqseRbZY",
            },
            {
              lecture_id: 9,
              lecture_no: "2.2",
              title: "String Methods",
              video_link: "https://www.youtube.com/embed/bRAo6TJJjCU",
            },
            {
              lecture_id: 10,
              lecture_no: "2.3",
              title: "Introduction to the if Statement",
              video_link: "https://www.youtube.com/embed/FTX5wF_3J9Q",
            },
            {
              lecture_id: 11,
              lecture_no: "2.4",
              title: "If, Else, and Elif Conditions",
              video_link: "https://www.youtube.com/embed/-dBqiRCHbNw",
            },
            {
              lecture_id: 12,
              lecture_no: "2.5",
              title: "Introduction to Import Library",
              video_link: "https://www.youtube.com/embed/OdjXL5U95eI",
            },
          ],
        },
        {
          ...
          lectures: [
            {
              ...
              video_link: "https://www.youtube.com/embed/lvXuQ_x7EsI",
            },
            {
              lecture_id: 14,
              lecture_no: "3.2",
              title: "While Loop",
              video_link: "https://www.youtube.com/embed/SqMeT9caxpE",
            },
            {
              lecture_id: 15,
              lecture_no: "3.3",
              title: "Formatted Printing",
              video_link: "https://www.youtube.com/embed/DR0BhSzGnPo",
            },
            {
              lecture_id: 16,
              lecture_no: "3.4",
              title: "Nested For Loop",
              video_link: "https://www.youtube.com/embed/-4MRaWABCuo",
            },
            {
              lecture_id: 17,
              lecture_no: "3.5",
              title: "Break, Continue, and Pass",
              video_link: "https://www.youtube.com/embed/SVAVQHfJbE0",
            },
          ],
        },
      ],
  ...
  methods: {
    ...
    toggleLecture(lectureId) {
      this.currentLecture = this.weeks
        .flatMap((week) => week.lectures)
        .find((lecture) => lecture.lecture_id === lectureId);
    },
    ...
    async fetchSupplementaryMaterials() {
      try {
        ...
        for (const week of this.weeks) {
          ...
          materials[weekNo] = await this.fetchWeekSupplementaryMaterials(
            weekNo
          );
        }
    ...
    async fetchWeekSupplementaryMaterials(weekNo) {
      try {
        ...
        const response = await axios.get(
          `https://seek-protal-gzcname5gsghfhhj.centralindia-01.azurewebsites.net/api/supplementary/${this.courseId}/${weekNo}`,
          {
            headers: {
        ...
        console.error(
          `Error fetching supplementary materials for week ${weekNo}:`,
          error
        );
        return [];
      }
    ...
    viewSupplementary(fileUrl) {
      if (fileUrl) {
        ...
        const absoluteUrl = fileUrl.startsWith("http")
          ? fileUrl
          : `https://seek-protal-gzcname5gsghfhhj.centralindia-01.azurewebsites.net${fileUrl}`;
    ...
    async submitDoubt() {
      ...
      try {
        const response = await axios.post(
          "https://seek-protal-gzcname5gsghfhhj.centralindia-01.azurewebsites.net/api/submit-doubt",
          {
